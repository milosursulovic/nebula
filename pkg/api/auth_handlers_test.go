...
func newAuthTestServer(authSvc auth.Service, tokens auth.TokenIssuer) *http.Server {
	return NewServer(":0", fakePinger{}, authSvc, tokens, fakeNodeService{}, fakeInstanceService{}, fakeJobService{}, fakeNetworkService{}, fakeStorageService{}, noopDeleteVM, noopReleaseIP, testLogger(), testNodeBootstrapSecret)
}
