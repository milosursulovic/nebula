...
func newNetworkTestServer(networkSvc network.Service) (*http.Server, auth.TokenIssuer) {
	...
	return NewServer(":0", fakePinger{}, fakeAuthService{}, tokens, fakeNodeService{}, fakeInstanceService{}, fakeJobService{}, networkSvc, noopDeleteVM, noopReleaseIP, testLogger(), testNodeBootstrapSecret), tokens
}
