...
func newNetworkTestServer(networkSvc network.Service) (*http.Server, auth.TokenIssuer) {
	...
	return NewServer(":0", fakePinger{}, fakeAuthService{}, tokens, fakeNodeService{}, fakeInstanceService{}, fakeJobService{}, networkSvc, fakeStorageService{}, noopDeleteVM, noopReleaseIP, noopStartVM, noopStopVM, newFakeLimiter(), false, testLogger(), testNodeBootstrapSecret), tokens
}
