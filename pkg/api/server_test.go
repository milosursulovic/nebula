...
func TestHandleHealth(t *testing.T) {
	srv := NewServer(":0", fakePinger{}, fakeAuthService{}, testTokenIssuer(), fakeNodeService{}, fakeInstanceService{}, fakeJobService{}, fakeNetworkService{}, fakeStorageService{}, noopDeleteVM, noopReleaseIP, testLogger(), testNodeBootstrapSecret)
...
func TestHandleReady(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			srv := NewServer(":0", tt.pinger, fakeAuthService{}, testTokenIssuer(), fakeNodeService{}, fakeInstanceService{}, fakeJobService{}, fakeNetworkService{}, fakeStorageService{}, noopDeleteVM, noopReleaseIP, testLogger(), testNodeBootstrapSecret)
