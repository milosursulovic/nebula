...
// noopStartVM / noopStopVM are the default provisioning.VMStarter /
// VMStopper fakes for tests that don't care about agent-side start/stop.
func noopStartVM(ctx context.Context, instanceID, nodeID string) error { return nil }
